ну чтож поехали, тк мы пошли по сложному пути и решили не делать программу а именно приложение прям нам будет очень больно и неприятно, тк вообще мы могли в алгаритме написать 
